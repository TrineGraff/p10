...
dm.test(loss$abs$faktor_ic2...2....y.test, loss$abs$lasso_TG_kryds...2....y.test, alternative = "two.sided", h = 1, power = 1)
dm.test(loss$abs$faktor_ic2...2....y.test, loss$abs$lasso_TG_bic...2....y.test, alternative = "two.sided", h = 1, power = 1)
...
dm.test(loss$abs$faktor_ic2...2....y.test, loss$abs$LARS_TG_kryds...2....y.test, alternative = "two.sided", h = 1, power = 1)
dm.test(loss$abs$faktor_ic2...2....y.test, loss$abs$LARS_TG_bic...2....y.test, alternative = "two.sided", h = 1, power = 1)
...
dm.test(loss$abs$faktor_ic2...2....y.test, loss$sq$lasso_TG_kryds...2....y.test, alternative = "two.sided", h = 1, power = 1)
dm.test(loss$abs$faktor_ic2...2....y.test, loss$sq$lasso_TG_bic...2....y.test, alternative = "two.sided", h = 1, power = 1)
...
dm.test(loss$sq$faktor_ic2...2....y.test, loss$abs$LARS_TG_kryds...2....y.test, alternative = "two.sided", h = 1, power = 1)
dm.test(loss$sq$faktor_ic2...2....y.test, loss$abs$LARS_TG_bic...2....y.test, alternative = "two.sided", h = 1, power = 1)

...
\caption{\(p\)-værdier og konfidensintervaller for variablerne udvalgt af lasso, hvor $\widehat{\lambda}$ er estimeret ud fra krydsvalidering . Den estimeres standard afvigelse er \(0.043\), og resultaterne er for \(\lambda \approx 1.823\) med \(\alpha = 0.1\).} \label{tab:fixedLassoInf}
\end{table} 
...
\caption{\(p\)-værdier og konfidensintervaller for variablerne udvalgt af lars algoritmen. Den estimeres standard afvigelse er \(0.043\), og resultaterne er for \(\widehat{s}_{1 \text{sd}} = 20\) (estimeret udfra krydsvalidering) med \(\alpha = 0.1\).} \label{tab:larInf}
\end{table} 

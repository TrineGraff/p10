...
&$\boldsymbol{f}_{\textbf{1sd}}$ & \textbf{0.2424} & \textbf{0.0019} & \textbf{13 } & \textbf{94.43}\% &  \textbf{971.6687} \\ \bottomrule
 \end{tabular}}
\caption{Værdien af $f_{\min}$ og $f_{1\text{sd}}$, gennemsnitlig krydsvalideringsfejl, som er målt i MSE, antallet af parametre, justeret R$^2$ og log-likelihood for LARS og LARS algoritmen med lasso modifikation. De valgte tuning parametre for hver metode er markeret med tykt.} \label{tab:lars_lasso_tab}
\end{table}

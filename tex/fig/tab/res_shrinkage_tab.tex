...
LB$_{10}$-test &  0  && 0.0017 && 1.511 $\cdot 10^{-12}$  &&  0&  & 0 & 0 \\ \bottomrule \toprule
...
LB$_{10}$-test & 0 &&  0.0013 && $3.147 \vdot 10{-10} $ &  & 0 &&  0 & 0 \\  \bottomrule
 \end{tabular}}
\caption{Skewness, excess kurtosis, $p$-værdier for Jarque-Bera og Ljung-Box testen for de standardiserede residualer. Vi lader LB$_{10}$ betegne Ljung-Box test med lag = 10.} \label{tab:res_shrinkage_tab}
%\end{table}
\end{sidewaystable}

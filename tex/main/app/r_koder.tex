...
\rfile[firstline=10,lastline=28]{../R/Rkoder/unrate/autoregressive_model/insample.R}
%
Vi anvender funktionen \texttt{beta} til at estimere parametrene udfra OLS. 
\rfile[firstline=35,lastline=74]{../R/Rkoder/unrate/autoregressive_model/insample.R}

Funktionen \texttt{ForecastAR} anvendes til prædiktion.
\rfile[firstline=5,lastline=20]{../R/Rkoder/unrate/autoregressive_model/outsample.R}

\section{Faktor modellen} \label{sec:faktor}
Funktionen \texttt{estFactors} bruges til at estimerer faktorerne.
\rfile[firstline=24,lastline=58]{../R/Rkoder/unrate/faktor_model/insample.R}
%
Funktionen \texttt{estFactors} anvendes til identificere faktorerne. 
%
\rfile[firstline=7,lastline=22]{../R/Rkoder/unrate/faktor_model/insample.R}
%
Funktionen \texttt{ForecastFaktor} anvendes til prædiktion.
\rfile[firstline=20,lastline=44]{../R/Rkoder/unrate/faktor_model/outsample.R}
...
\rfile[firstline=2,lastline=32]{../R/Rkoder/unrate/lasso_generaliseringer/coordinate/bic.R}
%

...
\begin{align*}
Q = n \del{n +2} \sum_{k=1}^h \frac{\widehat{\rho}_k^2}{n-k},
\end{align*}
...
\end{defn}
Under \(\hyp_0\) følger teststørrelsen \(Q\) en \(\chi_{\del{h}}^2\)-fordeling.
For et signifikant niveau \(\alpha\), afvises hypotesen hvis \(Q > \chi_{1-\alpha,h}^2\), hvor \(\chi_{1-\alpha,h}^2\) er en \(1 - \alpha\) kvantil af \(\chi^2\)-fordelingen med \(h\) frihedsgrader.

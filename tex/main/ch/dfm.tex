\chapter{Faktor model} \label{ch:dfm}
...
Faktor modellen er motiveret af følgende argument: antag variablerne kan opdeles i grupper udfra deres korrelation, således at variable i en gruppe har høj parvis korrelation, mens variablerne har relativ lav korrelation med variabler i andre grupper.

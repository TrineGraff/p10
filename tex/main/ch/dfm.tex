...
\begin{ass}[Faktorer og faktor loadings]
\begin{enumerate}
...
\begin{ass}[Momenter af fejlene \(e_t\)]
\begin{enumerate}
...
%Yderligere en reskaleret estimator af faktorerne er defineret som \(\bar{F}^r = \hat{F}^r \del{{\hat{F}^r}^T \hat{F}^r T^{-1}}^{1/2}\), og den asymptotiske egenskaber er givet i sætn 1 af Bai og Ng (2002).
...
Tre af straf funktioerne foreslået af \citep{Bai_Ng}
\begin{align*}

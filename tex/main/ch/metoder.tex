...
\text{IC}_3 \del{k} &= \ln V \del{k, \widehat{\tF}} + k \frac{\ln \del{\min \cbr{p, T}}}{\min \cbr{p, T}}, \label{eq:ic:3}
\end{align}
...
\begin{align*}
R_{\text{\text{MSE}}} = \frac{\text{MSE}_{\text{Alternativ}}}{\text{MSE}_{\text{Benchmark}}}, \qquad R_{\text{MAE}} = \frac{\text{MAE}_{\text{Alternativ}}}{\text{MAE}_{\text{Benchmark}}}.
\end{align*} 

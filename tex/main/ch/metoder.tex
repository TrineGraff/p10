...
Derudover vil vi betragte et rullende tabs ratio, som vi betegner $R_{t}^\text{MSE}$ og $R_t^\text{MAE}$, for at vurdere modellernes prædiktion fra observation til observation.
%

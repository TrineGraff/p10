...
\textit{I dette kapitel præsenteres først nogle optimeringsbetinger, og derefter optimeringsalgoritmerne coordinate descent og Least Angle Regression (LARS), som kan løse lasso problemet.
...
Heldigvis findes der en naturlig generalisering af begrebet gradient for konvekse funktioner.

For differentiable, konvekse funktioner giver tangent approksimationen af første ordens en nedre grænse.

...
\begin{align*}
\widehat{\tbeta}^\text{naivEN} = \argmin_{\tbeta \in \R^p} \cbr{\Vert \y - \X \tbeta \Vert_2^2}, \ \text{underlagt at } \frac{1}{2}\del{1-\alpha} \Vert \tbeta \Vert_2^2 + \alpha \Vert \tbeta \Vert_1 \leq t,
\end{align*}

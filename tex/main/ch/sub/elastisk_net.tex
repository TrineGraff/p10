...
\begin{align*}
\hat{\beta}^\text{naivEN} &= \argmin_{\beta} \cbr{ \left\Vert \begin{bmatrix}
\y \\ \mathbf{0}
...
&= \argmin_{\beta} \cbr{ \left\Vert \begin{bmatrix}
\y \\ \mathbf{0}
...
&= \argmin_{\beta} \cbr{ \del{\y^T \y - 2 \beta^T \X^T \y + \beta^T \X^T \X \beta} + \lambda_1 \Vert \beta \Vert_1} \\
...
0, &\hat{\beta}_j^\text{OLS} \leq \frac{\lambda_1}{2} \\
\hat{\beta}_j^\text{OLS} - \frac{\lambda_1}{2}, \quad &\hat{\beta}_j^\text{OLS} > \frac{\lambda_1}{2}
\end{cases}. 
\end{align*}
...
dvs
\begin{align*}
\Vert \hat{r} \del{\lambda_1, \lambda_2} \Vert_2^2 + \lambda_2 \Vert \hat{\beta} \del{\lambda_1, \lambda_2} \Vert_2^2 + \lambda_1 \Vert \hat{\beta} \del{\lambda_1, \lambda_2} \Vert_1 \leq \Vert \y \Vert_2^2.  
\end{align*}
Dermed er \(\Vert \hat{r} \del{\lambda_1, \lambda_2} \Vert_2 \leq \Vert \y \Vert_2\) og \eqref{eq:EN4} medfører, at
\begin{align*}
D_{\lambda_1, \lambda_2} \del{i,j} &= \frac{1}{\Vert \y \Vert_1} \left\vert \frac{1}{\lambda_2} \del{\mathbf{x}_i^T-\mathbf{x}_j^T} \hat{r}\del{\lambda_1, \lambda_2} \right\vert \\ 
...
\begin{align}
\hat{\beta}^\text{EN} = \argmin_\beta \cbr{ \del{\beta^T \del{\frac{\X^T \X + \lambda_2 \mathbf{I}}{1 + \lambda_2}} \beta - 2 \y^T \X \beta} + \lambda_1 \Vert \beta \Vert_1}. \label{eq:EN6}
\end{align}
\end{thm}
\begin{proof}
Vi har, at
...
\begin{align*}
\hat{\beta}^\text{EN} &= \argmin_{\beta} \cbr{\y^T \y - 2 \frac{\y^T \X \beta}{1+\lambda_2} + \beta^T \del{\frac{\X^T \X + \lambda_2 \mathbf{I}}{\del{1+\lambda_2}^2}} \beta + \frac{\lambda_1 \Vert \beta \Vert_1}{1+\lambda_2}} \\ 
&= \argmin_{\beta} \cbr{\frac{1}{1+\lambda_2} \del{- 2 \y^T \X \beta + \beta^T \del{\frac{\X^T \X + \lambda_2 \mathbf{I}}{1+ \lambda_2}} \beta + \lambda_1 \Vert \beta \Vert_1} + \y^T \y} \\
&= \argmin_{\beta} \cbr{  - 2 \y^T \X \beta + \beta^T \del{\frac{\X^T \X + \lambda_2 \mathbf{I}}{1+ \lambda_2}} \beta + \lambda_1 \Vert \beta \Vert_1}.
\end{align*}
\end{proof}
%

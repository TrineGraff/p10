...
Lemma \ref{lem:elastisk_net} viser også, at elastisk net udfører variabel udvægelse svarende til lasso.
%
\begin{exmp}
...
\end{minipage}
\caption{Koefficientstierne for henholdsvis lasso (ventre) og elastisk net med \(\alpha=0.3\) (højre) plottet imod \(\ell_1\)-normen.} \label{fig:crime_koef_EN}
\end{figure}
%

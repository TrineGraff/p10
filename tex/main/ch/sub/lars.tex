...
\imgfigh{lars_kryds.pdf}{1}{10-fold krydsvalideringsfejl som funktion af fraktion af \(\ell_1\)-norm LARS og LARS algoritmen med lasso modifikation. De stiplede linjer indikerer \(f_\text{min}\) og \(f_\text{1sd}\).}{lars_kryds}

Tabel \ref{tab:lars_lasso_tab} giver fraktion af \(\ell_1\)-normen, gennemsnitlige krydsvalideringsfejl, antallet af parametre, justeret R$^2$ og log-likelihood for LARS og LARS algoritmen med lasso modifikation. 

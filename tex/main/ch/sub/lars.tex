...
%
For de valgte variable udfører algoritmen 21 steps, hvor variablerne  \textcolor{chartreuse4}{CUMFNS}, \textcolor{blue3}{MANEMP} \textcolor{orange}{GS1} tilføjes og fjernes igen. 

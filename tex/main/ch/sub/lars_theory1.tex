...
For mere end to kovarianter, tages LARS steps langs vektorer, hvis vinkler er lige store. ???? Dette betegnes som en ensvinklet vektor.
...
Højre figur vises de absolutte nuværende korrelationer
\begin{align*}

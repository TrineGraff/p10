\section{LARS}
%LARS er en variabeludvælgelses algoritme, som er mindre grådig end traditionelle forward selection metoder. 
...
\begin{figure}[H]
\centering
\scalebox{0.6}{\includegraphics{fig/crime_lar.pdf}}

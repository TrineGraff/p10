...
%\begin{align}
%\argmin_{\mathbf{c} \in \mathbb{R}^p}  \cbr{\Vert \y - \sum_{j=1}^p c_j \x_j \tilde{\beta}_j \Vert_2^2 + \lambda \sum_{j=1}^p c_j}, \ \text{underlagt at } c_j \geq 0, \label{eq:nonnegative_garrote}
%\end{align}
%hvor \(\lambda \geq 0\).

...
\begin{itemize}
	...
	\item \texttt{ggplot2}\fcite{ggplot2}
	\item \texttt{glmnet}\fcite{glmnet}, 
	\item \texttt{gglasso}\fcite{gglasso}, group lasso
	\item \texttt{lars}\fcite{lars}, least angle regression
	\item \texttt{forecast}\fcite{forecast}, Diebold-Mariano testen
	\item \texttt{MCS}\fcite{MCS}, til at bestemme model confidence set bootstrapping
\end{itemize}
%
